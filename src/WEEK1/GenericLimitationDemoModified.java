...
class Student3<T extends Number> {
    String name;
    T[] marks;
    ...
    boolean compareMarks(Student3<?> others) {
...
public class GenericLimitationDemoModified {
    public static void main(String[] args) {
        Integer[] intMarks1 = {44, 55, 33, 66, 77};
        Student3<Integer> s1IntMarks = new Student3<Integer>(intMarks1);
        System.out.println("Total marks " + s1IntMarks.total());

        Integer[] intMarks2 = {49, 39, 53, 69};
        Student3<Integer> s2IntMarks = new Student3<Integer>(intMarks2);
        ...
        Student3<Double> s3DoubleMarks = new Student3<Double>(doubleMarks);
        System.out.println("Total marks " + s3DoubleMarks);

        Float[] floatMarks = {50.0F, 40.0F, 60.0F, 65.0F};
        Student3<Float> s4FloatMarks = new Student3<Float>(floatMarks);
